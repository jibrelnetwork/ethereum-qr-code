...
var _etheriumQRplugin = __webpack_require__(1);
...
var _tokenIcon = __webpack_require__(2);

var _tokenIcon2 = _interopRequireDefault(_tokenIcon);

var _utils = __webpack_require__(3);

var _qrcodejs = __webpack_require__(4);
...
var etheriumQRplugin = function () {
    ...
    _createClass(etheriumQRplugin, [{
        ...
        value: function generate(config) {
            ...
            var generatedCode = this.schemaGenerator(this.tokenAdress, this.tokenName, this.tokenAmount);
			console.log(this.uiElement, generatedCode);
            new _qrcodejs2.default(this.uiElement, {
                text: generatedCode,
                width: this.size,
                height: this.size
            });
        ...
        value: function parseRequest(request) {
            ...
            this.schemaGenerator = request.schema === 'bitcoin' ? _utils.tokenSchemaBitcoin : _utils.tokenSchemaEIP67;
        }
    }, {
        key: 'drawTokenIcon',
        value: function drawTokenIcon() {
            ...
            if (this.imgUrl) {
                ...
                iconDraw.addIcon(this.imgUrl, this.size, this.uiElement, function () {
                    _this.uiElement.parentNode.removeChild(_this.uiElement);
                });
            }
        }
    }, {
        key: 'drawQrCodeContainer',
        value: function drawQrCodeContainer() {
...
var tokenSchemaEIP67 = exports.tokenSchemaEIP67 = function tokenSchemaEIP67(adress, gas, data) {
  return 'ethereum:' + adress + '?gas=' + gas + '&data=' + data;
};
var tokenSchemaBitcoin = exports.tokenSchemaBitcoin = function tokenSchemaBitcoin(adress, token, amount) {
  var standart = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'erc20';
